...
def main():
    ...
    parser.add_argument("--eval_path",default="SentEval/data/downstream/STS/STSBenchmark/sts-dev.csv",help="eval path")
    ...
    res_dir = "/home/xb/SimCSE_3/result.txt"
    with open(res_dir,"a",encoding="utf8") as f:
        f.write(str(scores))
    print(scores)
